...
import { logoFacebook, logoTwitter, logoGoogle, logoGithub, closeOutline, eyeOutline, eyeOffOutline } from "ionicons/icons";
      ...
      <div className="w-full max-w-md bg-gray-800 bg-opacity-50 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden border border-gray-700 border-opacity-30">
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Sign in to continue your gaming journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 pr-12 py-3 bg-gray-900 bg-opacity-50 border border-gray-700 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent outline-none transition-all duration-300"
                required
              />
              <button
                type="button"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 text-yellow-500 bg-gray-900 bg-opacity-50 border-gray-700 rounded focus:ring-yellow-500 focus:ring-offset-gray-800 focus:ring-offset-2 focus:ring-2"
                />
        ...
        <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 bg-opacity-10 p-4 text-center">
          <p className="text-sm text-yellow-300">
            Sign in to access exclusive game content and member discounts
          </p>
        </div>
      </div>
    </div>
